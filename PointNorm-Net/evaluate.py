# evaluation.py run normal estim
...
parser.add_argument('--normal_results_path', type=str, default='./log/DeepFit_jet_order_1_100num_90_100_4point_difpcanum_32_128_256_450_0000005_0.25loss/results_999', help='Log dir [default: log]')
...
parser.add_argument('--dataset_list', type=str,
                    default=['testset_no_noise', 'testset_low_noise', 'testset_med_noise', 'testset_high_noise', 'testset_vardensity_gradient', 'testset_vardensity_striped'], nargs='+',
